...
class MessagesViewController: JSQMessagesViewController {
    ...
    var displayName = "Teddy"
    var userID = "facebook:10153696977173592"
    var members = []
    ...
    func setupFirebase() {
        ...
        messagesRef.queryLimitedToNumberOfChildren(25).observeEventType(FEventType.ChildAdded, withBlock: { (snapshot) in
            ...
            let message = Message(text: text, sender: sender, imageUrl: imageUrl, displayName: displayName)
    ...
    func tempSendMessage(text: String!, sender: String!) {
        let message = Message(text: text, sender: sender, imageUrl: senderImageUrl, displayName: displayName)
...
//        groupName.title = "Group Chat"
        ...
        if let urlString = profileImageUrl {
            setupAvatarImage(displayName, imageUrl: urlString as String, incoming: false)
    ...
    override func collectionView(collectionView: JSQMessagesCollectionView!, avatarImageViewForItemAtIndexPath indexPath: NSIndexPath!) -> UIImageView! {
        ...
        if let avatar = avatars[message.sender()] {
            ...
            setupAvatarImage(message.displayName()!, imageUrl: message.imageUrl(), incoming: true)
